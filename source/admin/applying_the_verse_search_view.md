# Applying the Verse search view changes to existing mail files
...
9.  In the Domino server console, type the following commands:
    ...
    **Note:** The design changes need to be applied when the server is running Verse 3.2.5 and above. If an older version of Verse is deployed and the design changes are applied, Verse users will see issues with the search results.
