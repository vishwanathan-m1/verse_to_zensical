...
Starting in {{ shortVerseProductName }}, new notes.ini entries can control the timeout length for GET and POST requests. 
...
To view notes.ini settings for {{ fullVerseProductName }}, see [notes.ini](../admin/notes.ini.md) settings.
