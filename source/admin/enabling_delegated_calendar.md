...
This feature is disabled by default and can enabled by applying the notes.ini setting VOP\_GK\_FEATURE\_296=1 on the Domino server that runs {{ shortVerseProductName }}.
