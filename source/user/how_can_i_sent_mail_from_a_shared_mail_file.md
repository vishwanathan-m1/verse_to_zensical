...
This feature requires Domino version 12.0.1 FP1 or higher. All mail files should use the Domino 12 mail template. In addition, you must select the **Enable Alternate From Feature** preference with the Notes client. For more information, see **Notes documentation: Selecting an alternate From address in a shared mail file**.
