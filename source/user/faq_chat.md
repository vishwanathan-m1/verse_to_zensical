...
![Chat icon for person.](images/interact2.jpg)
...
![Chat icon for offline user](images/chatuser_offline%20mode.png) ![Chat icon for user with DND status](images/chatuser_DNDmode.png)
