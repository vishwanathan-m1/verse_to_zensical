...
To open an archive mail file, from the Folders panel in mail, click the archive folder ![archive folder icon](images/archiveicon.png) at the end of your folder list. For example:

![archive folder example](images/archivefolder.png)
...
![An archive called VOP_Archive selected in the Folders drop-down](images/archiveamessage.png)
...
![Restore action and Restore and Delete action](images/restorearchivedmessage.png)
