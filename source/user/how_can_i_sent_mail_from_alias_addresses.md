...
{% endif %}
Click **{{ shortVerseProductName }} Settings** &gt; **Mail** and in the **Sent From Addresses** section select **Enable sending message from your email aliases**.

![enable sent from](images/enable%20sent%20from.png)

Next, click **Compose** and in the **From** field select the address to use from the dropdown list.

![sent from dropdown list](images/sentfrom_mymails.png)
