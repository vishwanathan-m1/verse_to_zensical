...
<img src="../user/images/dociqsearch.png" width="40%" alt="HCL Doc chat preview">
...
2. Select the feedback option associated with the response thumbs up ![Thumbs up](images/thumbs-up.png) or thumbs down ![Thumbs down](images/thumbs-down.png)
