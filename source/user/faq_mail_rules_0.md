...
2.  Select the folder ![folder icon](images/folder.png) in the toolbar and then select the Junk folder ![Junk icon](images/junkfolder.png).
3.  You see the message **Your message was moved to Junk**. To send future messages to Junk, click **Add users to the Junk Mail rule**.
    ...
    ![Message with the "Add users to the Junk mail rule" prompt](images/add_users_to_junk_mail_rule.png)
...
4.  You see the message **The sender\(s\) have been added to the Junk Mail rule.** If you want to open the Junk Mail rule in Mail settings, click**View Junk Mail Rule**
    ...
    ![Message with the "View Junk Mail Rule" prompt](images/view_junk_mail_rule.png)

    The Junk Mail rule setting looks like this:

    ![Junk mail rule setting](images/junk_mail_rule_in_preferences.png)
