...
3.  Select the address to remove from type-ahead and click **Remove from Type-ahead**.
    ...
    ![With George Tompkins/Hannover selected, select Remove from Type-ahead](images/removefromtypeahead.png)
...
1.  Click **Manage Removed Addresses** to display addresses you have removed.
    ...
    ![Managed Removed Addresses button](images/managedremovedaddresses.png)
