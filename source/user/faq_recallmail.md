...
![Recall message](images/DW_Recallmail.png)
{% else %}
![Recall message](images/Recallmail.png)
{% endif %} 
...
![Recall message dialog](images/Recallmail_dialog.png)

In the Mail section of {{ shortVerseProductName }} Settings, you can choose to allow or not allow others to be able to recall mail they sent to you. The checkbox is selected by default. If you deselect the checkbox, others will not be able to recall messages sent to you.

![Recall mail checkbox in {{ shortVerseProductName }} settings](images/Recallmail_checkbox.png)
