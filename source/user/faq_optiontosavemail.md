...
2.  Choose from the three options to save sent mail:
    ...
    ![Save Sent Mail options image](images/faq_savesent.png)
    ...
    -   **Ask if sent mail should be saved** - This option prompts when you press the **Send** button when composing mail. ![mail. Save Send prompt image.](images/faq_sendprompt.png)
