...
Folders provide a lightweight way for you to organize messages. Folder operations in HCL Verse®, such as moving messages to a folder, carry over to HCL Notes®, and folder operations in those clients carry over to Verse.

When you first log into Verse, the Folders display is collapsed by default. To see your full folder tree, click on the "Toggle folders" button ![](images/FoldersIcon.jpg).
...
When you hover your pointer on a folder you've created, an "Edit" button displays ![](images/pencil_icon.jpg). Click it to bring up additional folder options, including:
