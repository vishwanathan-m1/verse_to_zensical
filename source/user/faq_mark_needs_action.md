...
**Note:** If you prefer to track messages that need a response in the message list by marking them as Unread, you can do so by clicking the ![Unread icon](images/unread.png) icon.

You can add a mail message and its associated action items to the **Needs Action** queue by selecting the Needs Action icon ![](images/io_24.png) in either the message list or the message itself. You also have the option to add some additional notes about the item and select a date by which to complete it; Today, Tomorrow, Anytime, or choose your own date.

The mail message is now in the **Needs Action** queue, which you can view by selecting the Needs Action list ![](images/NeedsActionMenuBarSmaller.jpg) from the top menu bar.

![Needs Action list](images/needs_action_list.jpg)
