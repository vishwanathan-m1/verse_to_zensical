...
Look at the **% of storage used** information at the bottom of the **Folder** panel. Click the ![](images/MailQuota_infoicon.png) icon for more information about the quota.

![Displaying the storage quota](images/MailQuota_display.png)
