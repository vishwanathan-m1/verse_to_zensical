...
1. Click your profile image in the navigator bar and click **Verse Settings** &gt; **Delegation**.

2. Search for the person to whom you want to grant access. Specify whether they have access to Mail, Calendar, and Contacts or only your Calendar and Contacts and the type of access. Wondering how Verse access levels map to HCL Notes access levels? See [What delegation access levels are available?](faq_delegation_access_levels_on_prem.md).
...
## Warning when access levels are not optimized for HCL Verse
