...
1.  Click the ![delegation panel icon](images/delegationbutton.png) icon in the navigation bar to open the delegation panel for Mail and Calendar Access list.
2.  Search for and select the name of the mail-in database to add it to the list.

    ![Search bar in the Mail and Calendar Access list](images/mailin1.png)
