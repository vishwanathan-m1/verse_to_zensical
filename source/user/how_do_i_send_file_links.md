...
![Screenshot of a toolbar below includes icons for text formatting, inserting an image, attaching a file, an attachment folder, and scheduling. The attachment folder icon is highlighted with a yellow outline, indicating it's selected or in focus. An 'Options' link appears on the right side of the toolbar, and the message body area below is blank with the text cursor positioned at the beginning, ready for composing an email.](../user/images/click_dominofiles.png)
...
![Email attachment interface with a tooltip reading "Save to Domino Files".](../user/images/dominofile_save.png)
3. When *Saved*, there is notification link that you can view the files on your cloud storage.
![Screenshot of an email interface showing a notification banner that reads "unnamed (1).png was added to Files" with a "View in My Files" link..](../user/images/viewfiles.png)
